...
export default function More() {
  return (
    <Popover className='relative'>
      <Popover.Button className='block group py-[3px] outline-none'>
        <div
      ...
      <Popover.Panel className='w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-auto'>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className='h-[52px] text-[15px] flex w-full items-center justify-between bg-black px-4 text-left  font-medium hover:bg-[#eff3f41a] focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75'>
                ...
                >
                  <path
                    fill={open ? '#1d9cf0' : '#e7e9ea'}
                    d='M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z'
                  ></path>
                </svg>
              </Disclosure.Button>
              <Disclosure.Panel className=''>
                <button className='p-3 w-full transition-colors text-[15px] inline-flex items-center gap-5 hover:bg-[#eff3f41a]'>
                  <div className='w-[18.75px] h-[18.75px] relative'>
                    <svg
                      viewBox='0 0 24 24'
                      width={18.75}
                      height={18.75}
                  ...
                  <div className='pr-4 font-bold'>İstatiskler</div>
                </button>
              </Disclosure.Panel>
            </>
          )}
            ...
            <>
              ...
              <Disclosure.Panel className=''>
                <button className='p-3 w-full transition-colors text-[15px] inline-flex items-center gap-5 hover:bg-[#eff3f41a]'>
                  ...
                  <div className='pr-4 font-bold'>Reklamlar</div>
                </button>
              </Disclosure.Panel>
            </>
          )}
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className=''>
                <Link
                  to='/'
                  className='p-3 w-full transition-colors text-[15px] inline-flex items-center gap-5 hover:bg-[#eff3f41a]'
                >
                  <div className='w-[18.75px] h-[18.75px] relative'>
                    <svg
                      viewBox='0 0 24 24'
                  ...
                  <div className='pr-4 font-bold'>Ayarlar ve gizlilik</div>
                </Link>
                <Link
                  to='/'
                  className='p-3 w-full transition-colors text-[15px] inline-flex items-center gap-5 hover:bg-[#eff3f41a]'
                >
                  ...
                  <div className='pr-4 font-bold'>Yardım Merkezi</div>
                </Link>
                <Link
                  to='/'
                  className='p-3 w-full transition-colors text-[15px] inline-flex items-center gap-5 hover:bg-[#eff3f41a]'
                >
                  ...
                  <div className='pr-4 font-bold'>Görünüm</div>
                </Link>
                <Link
                  to='/'
                  className='p-3 w-full transition-colors text-[15px] inline-flex items-center gap-5 hover:bg-[#eff3f41a]'
                >
                  ...
                  <div className='pr-4 font-bold'>Klavye kısayolları</div>
                </Link>
              </Disclosure.Panel>
            </>
          )}
